...
- [x] Substitute receipt documents: create a form, save submitted documents, generate a standard-format substitute receipt PDF with raw evidence files annexed directly after it, and store the raw evidence files.
