...
- `c4ba772`: สคริปต์ migration สถานะเอกสารที่ออกเลขแล้วแบบ fixture-only และ dry-run ผ่านการทดสอบเบื้องต้น 14 รายการ; ครอบคลุม REQ/SR mapping, O15 legacy draft read-only, apply backup gate และ retry แต่ยังรอ Architecture/Security review ก่อนใช้งานจริง และยังไม่อนุญาต live apply
